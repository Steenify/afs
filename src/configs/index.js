...
export const PERMITTIONS_CONFIG = {
  ...
  VIEW_ORDER_SOURCE: 'VIEW_ORDER_SOURCE',
  ASSIGN_ORDER_TO_STORE: 'ASSIGN_ORDER_TO_STORE',
  VIEW_ORDER_OF_STORE: 'VIEW_ORDER_OF_STORE',
  CAN_SEE_BUDGET_ORDER: 'CAN_SEE_BUDGET_ORDER',
  CAN_SEE_ASSIGN_ORDER: 'CAN_SEE_ASSIGN_ORDER',
  CAN_SEE_FILTER_VENDER: 'CAN_SEE_FILTER_VENDER',
};
