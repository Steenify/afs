...
export const PERMITTIONS_CONFIG = {
  ...
  CREATE_ORDER_TODO_LIST: 'CREATE_ORDER_TODO_LIST',
  RESOLVED_ORDER_TODO_LIST: 'RESOLVED_ORDER_TODO_LIST',
  REMOVE_ORDER_TODO_LIST: 'REMOVE_ORDER_TODO_LIST',
  ...
  DELETE_ARTIST_BUDGET: 'DELETE_ARTIST_BUDGET',
};
...
export const WORKFLOW_STATE_TYPE = {
  START: 'START',
  MIDDLE: 'MIDDLE',
  DONE: 'DONE',
};

export const WORKFLOW_TRANSITION_ACTION_TYPE = {
  APPROVE: { name: 'APPROVE', friendlyName: 'Approved' },
  REJECT: { name: 'REJECT', friendlyName: 'Reject' },
  CANCEL: { name: 'CANCEL', friendlyName: 'Cancel' },
  RESTART: { name: 'RESTART', friendlyName: 'Restart' },
  RESOLVE: { name: 'RESOLVE', friendlyName: 'Resolved' },
};

export const ORDER_STATUS_FRIENDLY = [
  { name: 'NEW', friendlyName: 'New' },
  { name: 'IN_PROGRESS', friendlyName: 'In Progress' },
  { name: 'PARTIAL_FULLFILLED', friendlyName: 'Partial Fulfilled' },
  { name: 'FULLFILLED', friendlyName: 'Fulfilled' },
];

export const ORDER_STATUS = {
  NEW: 'NEW',
  IN_PROGRESS: 'IN_PROGRESS',
  PARTIAL_FULLFILLED: 'PARTIAL_FULLFILLED',
