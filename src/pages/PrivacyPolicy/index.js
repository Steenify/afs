...
class PrivacyPolicy extends Component {
  render() {
    return (
      <section className='faqs mt-5 mb-5'>
        <div className='container'>
          <h1 className='title-page mb-3'>PRIVACY POLICY</h1>
          <div className='faqs__wrapper'>
            <div>
              <p>
                Whilst visiting the AFS website we collect various &nbsp;pieces
                of information from you to help us provide a better service in
                the future.
              </p>
              <p>
                When ordering or registering on our site, as appropriate, you
                may be asked to enter your: e-mail address. You may, however,
