...
import { getAllNotificationsService, createNotification, deleteNotification, publishNotification, getNotificationsCountService, readAllNotificationService } from 'services/notification.service';

export const GET_NOTIFICATIONS = actionCreator('GET_NOTIFICATIONS');
export const getAllNotificationsAction = (data) => async (dispatch) => {
  const params = {
