    ...
    <form action='' onSubmit={onSave}>
      <div className='comfirm_cus'>
        ...
        <div className='comfirm_cus__body'>
          ...
          <div>
            <Dropbox className='upload' ref={dropbox} orderNumber={orderNumber} id={`Reject__modal__upload`} />
          </div>
        </div>
        <div className='comfirm_cus__footer text-right'>
          ...
          <button className='comfirm_cus__delete comfirm_cus__control' onClick={onSave}>
            Reject
          </button>
        </div>
      </div>
