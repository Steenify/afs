!(function (V) {
    ...
    var r = {},
      ...
      H = {
        ...
        getOuterHTML: function (e) {
          ...
          return $t(t)
            ? t.outerHTML
            : na('<div></div>').append(na(t).clone()).html();
        },
  ...
  function gv(i, a) {
    ...
    return {
      findAll: function (e, n) {
        var t, r;
        (n = n || x(!0)),
          (t = H((r = e) ? te(r.getElementsByTagName('img')) : [], function (
            e,
          ) {
            var t = e.src;
            return (
  ...
  var wb = function (e, t) {
    ...
    OC = function (e, t) {
      return (
        (n = t),
        R.from(n.getNode(!0)).map(Ne.fromDom).exists(Er) ||
          AC(!1, e, t).isSome()
      );
      var n;
    },
    ...
    Xx = function (g) {
      var h,
        ...
        s = function (e, t) {
          ...
          var p = Ne.fromDom(n);
          return (
            z(Ua(Ne.fromDom(g.getBody()), '*[data-mce-selected]'), function (
              e,
            ) {
